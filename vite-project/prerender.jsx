  ...
  switch (url) {
    case '/':
      return React.createElement('div', null,
        ...
        React.createElement('p', null, 'Calculate your running pace, plan fuel strategy, and find elevation profiles for your training.')
      )
    case '/calculator':
      return React.createElement('div', null,
        React.createElement('h1', null, 'Pace Calculator'),
        React.createElement('p', null, 'Advanced running pace calculator for training and race planning.')
      )
    case '/fuel':
      return React.createElement('div', null,
        React.createElement('h1', null, 'Fuel Planner'),
        React.createElement('p', null, 'Plan your fuel strategy for long runs and races.')
      )
    case '/elevationfinder':
      return React.createElement('div', null,
        React.createElement('h1', null, 'Elevation Finder'),
        React.createElement('p', null, 'Find elevation profiles for your running routes.')
      )
    default:
      if (url.includes('/preview-route/')) {
        ...
        return React.createElement('div', null,
          ...
          React.createElement('p', null, `Explore running routes in ${city} with elevation profiles and pace recommendations.`)
        )
      }
      return React.createElement('div', null,
