      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed bg-yellow-50 p-4 rounded-lg">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-muted-foreground mb-4 space-y-2 mt-4">
