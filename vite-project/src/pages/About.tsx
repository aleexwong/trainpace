      ...
      <section className="py-16 px-6 max-w-4xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <div className="prose prose-lg max-w-none text-left">
            ...
            <ul className="list-disc pl-6 mb-6 text-muted-foreground space-y-2 text-left">
              <li>
        ...
        {/* The Data */}
        <div className="mb-16 bg-muted border border rounded-lg p-8">
          <h3 className="text-2xl font-bold mb-4">The Numbers</h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <p className="text-sm text-muted-foreground mb-1">First Half Marathon</p>
              <p className="text-3xl font-bold text-foreground">3:01:00</p>
              <p className="text-sm text-muted-foreground">BMO Vancouver – May 2024</p>
              <p className="text-sm text-red-600 mt-2">
                Avg Pace: 8:38/km (13:54/mi)
              </p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground mb-1">PR Half Marathon</p>
              <p className="text-3xl font-bold text-blue-600">2:06:00</p>
              <p className="text-sm text-muted-foreground">BMO Vancouver – May 2025</p>
