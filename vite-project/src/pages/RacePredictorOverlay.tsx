...
Generated by TrainPace Race Predictor`;
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg bg-background rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Compact Header */}
        <div className="sticky top-0 bg-gradient-to-r from-blue-50 to-purple-50 border-b border px-6 py-4 rounded-t-2xl flex items-start justify-between">
          <div>
        ...
        <div className="p-6 space-y-4">
          {!result ? (
            ...
            <>
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-3 py-1 text-xs font-medium text-muted-foreground bg-muted hover:bg-gray-200 rounded-md transition-colors"
                  >
                    Edit
                  </button>
                  <button
              ...
              <div className="bg-muted rounded-lg px-3 py-2 border border">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-background rounded-lg p-3 text-center shadow-sm">
                    ...
                    <div className="text-xs text-muted-foreground mt-0.5">Pace</div>
                  </div>
                </div>
              </div>
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full flex items-center justify-between px-3 py-2 bg-muted rounded-lg hover:bg-muted transition-all"
            >
            ...
            {showMethodology && (
              <div className="mt-2 bg-muted border border rounded-lg p-4 space-y-2 text-xs text-muted-foreground">
                <p className="font-semibold text-foreground">Riegel's Formula</p>
                <p className="bg-background p-2 rounded font-mono border border">
                  T₂ = T₁ × (D₂ / D₁)^1.06
                </p>
