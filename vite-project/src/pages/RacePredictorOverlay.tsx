...
Generated by TrainPace Race Predictor`;
  ...
  return (
    ...
    >
      ...
      >
        {/* Compact Header */}
        <div className="sticky top-0 bg-gradient-to-r from-emerald-50 to-purple-50 border-b border-gray-200 px-6 py-4 rounded-t-2xl flex items-start justify-between">
          <div>
            ...
            <>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {RECENT_RACE_PRESETS.map((preset) => (
                  <button
                    ...
                    className="px-3 py-1 text-xs font-medium bg-emerald-50 text-emerald-700 hover:bg-emerald-100 rounded-full transition-all"
                  >
                    {preset.label}
                  </button>
                ))}
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  className="w-full py-3 text-base font-semibold bg-gradient-to-r from-emerald-600 to-purple-600 hover:from-emerald-700 hover:to-purple-700 text-white rounded-lg shadow-md disabled:opacity-50"
                >
                  🧠 Predict Time
                </Button>
              </div>
            ...
            <>
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={handleCopy}
                    className="p-2 rounded-md bg-emerald-50 hover:bg-emerald-100 transition-colors"
                    title="Copy"
                    aria-label="Copy"
                  >
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-purple-50 rounded-lg p-4">
