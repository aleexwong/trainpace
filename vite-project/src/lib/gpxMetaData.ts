...
function extractGPXMetadata(gpxContent: string) {
...
function simplifyToMaxPoints(points: GpxPoint[], maxPoints: number): GpxPoint[] {
...
export function processGPXUpload(gpxContent: string): {
    original: string;
    ...
    const metadata = extractGPXMetadata(gpxContent);
