...
const majorMarathonRoutes: MarathonRoute[] = [
  ...
  },
  {
    ...
    slug: "sydney",
    thumbnailPoints: [
      { lat: -33.8651, lng: 151.2099, ele: 20 },
      { lat: -33.8731, lng: 151.2152, ele: 15 },
    ],
  },
];
...
export default function PreviewRoutesDropdown() {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div
          className="absolute top-full left-0 mt-2 w-80 border rounded-lg shadow-lg z-50 max-h-96 overflow-y-auto"
