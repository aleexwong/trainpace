      ...
      <div className="bg-background rounded-lg max-w-md w-full shadow-xl">
        ...
        <div className="flex items-center justify-between p-6 border-b border">
          ...
          <button
            onClick={handleClose}
            disabled={isSaving}
            className=" border bg-gray-300 text-muted-foreground rounded-md hover:bg-gray-500 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex gap-3 p-6 border-t border">
          <button
            onClick={handleClose}
            disabled={isSaving}
            className="flex-1 px-4 py-2 border bg-gray-300 text-muted-foreground rounded-md hover:bg-gray-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
          <button
