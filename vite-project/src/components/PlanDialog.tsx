/**
 * Unified Plan Dialog
 * Modal for saving or editing a plan's name, notes, and race date.
 */
...
interface PlanDialogProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onSave: (planName?: string, notes?: string, raceDate?: string) => void | Promise<void>;
  /** External saving state (used in "save" mode). In "edit" mode, saving is tracked internally. */
  isSaving?: boolean;
  raceDistance: string;
  raceTime: string;
  /** Initial values for form fields (used in "edit" mode) */
  initialValues?: {
    planName?: string;
    notes?: string;
    raceDate?: string;
...
export function PlanDialog({
  ...
  const isSaving = mode === "edit" ? internalIsSaving : (externalIsSaving ?? false);
  ...
  }, [isOpen, initialValues?.planName, initialValues?.notes, initialValues?.raceDate]);
  ...
  const title = mode === "edit" ? "Edit Training Plan" : "Save Training Plan";
