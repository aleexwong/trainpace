...
export const planSeoPages: SeoPageConfig[] = [
  ...
  },
  {
    ...
    slug: '16-week-marathon-training-plan',
    tool: 'plan',
    path: '/plan/16-week-marathon-training-plan',
    title: '16-Week Marathon Training Plan | Free Generator | TrainPace',
    description: 'Free 16-week marathon training plan for intermediate runners. Week-by-week periodized schedule with daily workouts and pace zones. Export to Google Calendar.',
    h1: '16-Week Marathon Training Plan',
    intro: 'A 16-week marathon plan is designed for runners who already have a solid base and want focused, structured preparation. Four phases, 16 weeks, one finish line.',
    bullets: [
      '16 weeks of marathon-specific periodization',
      'Ideal for intermediate runners with existing base mileage',
      'Long runs peaking at 30–32 km, 3 weeks out',
      'Export to Google or Apple Calendar with one click',
    ],
    cta: { href: '/plan', label: 'Build My 16-Week Plan' },
    faq: [
      { question: 'Is 16 weeks enough time to train for a marathon?', answer: 'Yes, for runners who are already running regularly (30+ km per week). A 16-week marathon plan assumes you have an aerobic base in place. If you\'re starting from scratch or returning from a break, consider a 20-week plan to build the base first.' },
      { question: 'What should my long run peak be in a 16-week marathon plan?', answer: 'Peak long run in a 16-week plan is typically 30–32 km, completed 3 weeks before race day. This gives enough time to taper while maintaining race fitness. The final 3 weeks reduce volume significantly while keeping intensity.' },
      { question: 'How many days per week does a 16-week marathon plan require?', answer: 'Most 16-week marathon plans run 5 days per week: one long run, one tempo run, one interval session, and two easy recovery runs. Experienced runners can add a 6th day as an extra easy run.' },
    ],
    howTo: {
      name: 'How to follow a 16-week marathon training plan',
      description: 'Build a structured 16-week marathon training schedule',
      steps: [
        { name: 'Select Marathon', text: 'Choose Marathon as your goal race distance' },
        { name: 'Set your race date', text: 'Enter your race date — the plan will count back 16 weeks' },
        { name: 'Choose intermediate level', text: 'Select Intermediate or set your current fitness level' },
  ...
  },
  {
    ...
    slug: '20-week-marathon-training-plan',
    tool: 'plan',
    path: '/plan/20-week-marathon-training-plan',
    title: '20-Week Marathon Training Plan | Free Generator | TrainPace',
    description: 'Free 20-week marathon training plan for beginners and intermediate runners. Build from base to race day with a complete periodized schedule.',
    h1: '20-Week Marathon Training Plan',
    intro: 'Twenty weeks gives you the most complete marathon preparation: a full base-building phase, structured tempo and interval development, sharpening, and taper. The right choice for first-timers and runners targeting a PR.',
    bullets: [
      '20 weeks from base building to taper',
      'Conservative mileage progression to prevent injury',
      'Best for first marathons and PR attempts',
      'Export full schedule to Google or Apple Calendar',
    ],
    cta: { href: '/plan', label: 'Build My 20-Week Plan' },
    faq: [
      { question: 'Who should use a 20-week marathon training plan?', answer: 'A 20-week plan is ideal for first-time marathoners, runners returning from a break, and those targeting a significant PR. The extended base phase builds the aerobic foundation that makes speed work in later phases more effective.' },
      { question: 'How does a 20-week marathon plan differ from a 16-week plan?', answer: 'The primary difference is the base-building phase. A 20-week plan has 6–8 weeks of easy aerobic base running before structured quality sessions begin. A 16-week plan compresses this phase and assumes more existing mileage. Both plans peak at the same long run distance.' },
    ],
    howTo: {
      name: 'How to follow a 20-week marathon training plan',
      description: 'Build a complete 20-week marathon training schedule from base to race day',
      steps: [
        { name: 'Select Marathon', text: 'Choose Marathon as your goal race distance' },
        { name: 'Set race date 20 weeks out', text: 'Enter a race date at least 20 weeks from today' },
        { name: 'Choose your level', text: 'Beginner for first marathon, Intermediate for PR attempts' },
  ...
  },
  {
    ...
    slug: 'half-marathon-training-plan-beginners',
    tool: 'plan',
    path: '/plan/half-marathon-training-plan-beginners',
    title: 'Half Marathon Training Plan for Beginners | Free | TrainPace',
    description: 'Free beginner half marathon training plan. 16-week schedule with run/walk progression, easy base building, and complete race prep. Export to calendar.',
    h1: 'Beginner Half Marathon Training Plan',
    intro: 'Your first half marathon is 13.1 miles (21.1 km) of structured accomplishment. A 16-week beginner plan builds you from comfortable 5K runner to confident half marathon finisher.',
    bullets: [
      '16-week beginner-focused progression',
      'Start-to-finish prep for first-timers',
      'Run/walk options for early weeks',
      'Export to Google or Apple Calendar',
    ],
    cta: { href: '/plan', label: 'Build My Beginner Half Plan' },
    faq: [
      { question: 'How long should I train for my first half marathon?', answer: '16 weeks is ideal for most beginners. It provides enough time for base building (weeks 1–6), development (weeks 7–11), sharpening (weeks 12–14), and taper (weeks 15–16). If you\'re very new to running, consider starting with a 5K or 10K first.' },
      { question: 'How far should my longest run be before a half marathon?', answer: 'Your peak long run should be 18–19 km, completed 2–3 weeks before race day. You don\'t need to run the full 21.1 km in training — race-day adrenaline and taper will get you to the finish.' },
      { question: 'Can I walk during a half marathon?', answer: 'Absolutely. Many first-time half marathoners use a run/walk strategy, especially in the first few km. Training with run/walk intervals helps build fitness while managing impact.' },
    ],
    howTo: {
      name: 'How to follow a beginner half marathon training plan',
      description: 'Build a 16-week first half marathon training schedule',
      steps: [
        { name: 'Select Half Marathon', text: 'Choose Half Marathon as your goal race' },
        { name: 'Set your race date', text: 'Enter when your half marathon is' },
        { name: 'Choose Beginner', text: 'Select Beginner fitness level for appropriate progression' },
