...
export default function Ethos() {
  return (
    <>
      <PageTracker name="Ethos" props={{ page: "Ethics" }} />
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6 text-base sm:text-lg leading-relaxed text-foreground">
          ...
          <p>
            We believe performance is earned — not handed down. That tools
            should support action, not slow it. That momentum is built, not
            bought.
          </p>

          <p>
            This is for those who show up quietly. Who run without permission.
            Who train because it matters.
          </p>
